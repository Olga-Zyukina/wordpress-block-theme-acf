...
return array(
	'title'      => __( 'Search Page', 'edu-learn' ),
	'categories' => array( 'edu-learn-search' ),
...
<main class="wp-block-group" style="margin-top:0"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"100px","bottom":"100px"},"blockGap":"50px"}},"layout":{"type":"constrained","contentSize":"1320px","justifyContent":"center"}} -->
<div class="wp-block-group alignfull" style="padding-top:100px;padding-bottom:100px"><!-- wp:query-title {"type":"search","textAlign":"center","style":{"typography":{"fontSize":"42px","lineHeight":"1.24","fontStyle":"normal","fontWeight":"800","textTransform":"capitalize"}}} /-->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Type here...","width":588,"widthUnit":"px","buttonText":"Search","align":"center","style":{"typography":{"fontSize":"17px","fontStyle":"normal","fontWeight":"600"},"border":{"radius":"500px"},"elements":{"link":{"color":{"text":"var:preset|color|background-1"}}}},"backgroundColor":"primary","textColor":"background-1"} /--></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:post-date {"isLink":true,"metadata":{"bindings":{"datetime":{"source":"core/post-data","args":{"field":"date"}}}},"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|accent-3"}}}},"textColor":"accent-3","fontSize":"small"} /-->
...
<div class="wp-block-group has-background-3-background-color has-background" style="border-radius:16px;margin-top:80px;margin-bottom:80px;padding-top:5px;padding-bottom:5px"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}},"typography":{"fontSize":"19px","lineHeight":"1.84","textTransform":"none","fontStyle":"normal","fontWeight":"400"}},"textColor":"heading"} -->
